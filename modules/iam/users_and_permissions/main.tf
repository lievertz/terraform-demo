...
module "admin_group" {
  source                         = "git@github.com:lievertz/terraform-demo.git//modules/iam/group?ref=v0.0.7"
  group_name    = local.admin_name

}

module "admin_role" {
  source                         = "git@github.com:lievertz/terraform-demo.git//modules/iam/role?ref=v0.0.7"
